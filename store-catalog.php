...
<!-- Mirrored from html.nkdev.info/goodgames/store-catalog.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 12 Apr 2020 00:35:43 GMT -->
<head>
    <meta charset="utf-8">
...
produit.innerHTML+= '<div class="nk-gap-1"></div><div class="nk-product-price">'+row[i]['prix']+'dt</div><div class="nk-gap-1"></div> <a href="#" class="nk-btn nk-btn-rounded nk-btn-color-dark-3 nk-btn-hover-color-main-1">Add to Cart</a>'
...
document.getElementById("row vertical-gap").appendChild(contenaire);
            ...
            <div class="row vertical-gap" id="row vertical-gap">
